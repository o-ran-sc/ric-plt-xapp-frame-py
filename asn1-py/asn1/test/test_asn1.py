        ...
        return str(
            {
                ...
                indication_sequence_number: self.indication_sequence_number,
                indication_type: self.indication_type,
                indication_header: self.indication_header,
                indication_header_length: self.indication_header_length,
                indication_message: self.indication_message,
                indication_message_length: self.indication_message_length,
                call_process_id: self.call_process_id,
                call_process_id_length: self.call_process_id_length,
            }
        )
        ...
        return str(
            {
                ...
                request_sequence_number: self.request_sequence_number,
                function_id: self.function_id,
                action_admitted_list: self.action_admitted_list,
                action_not_admitted_list: self.action_not_admitted_list,
            }
        )
...
def test_call_decode_indication_and_clib_return_none_expect_error_raise(monkeypatch):
    ...
    monkeypatch.setattr("asn1.asn1._asn1_decode_indicationMsg",
...
def test_call_decode_sub_response_and_clib_return_none_expect_error_raise(monkeypatch):
    ...
    monkeypatch.setattr("asn1.asn1._asn1_decode_subRespMsg",
                        mock_decode_return_none)
...
def test_call_encode_sub_request_and_clib_return_error_expect_error_raise(monkeypatch):
    ...
    monkeypatch.setattr("asn1.asn1._asn1_encode_subReqMsg",
...
def test_call_encode_sub_request_expect_success(monkeypatch):
    ...
    sub_request = SubRequestMsg()
    try:
        sub_request.encode(1, 1, 1, bytes([1]), [1], [1], action_definitions, subsequent_actions)
    except BaseException as e:
        assert False
...
def test_call_encode_control_request_and_clib_return_error_expect_error_raise(monkeypatch):
    ...
    monkeypatch.setattr("asn1.asn1._asn1_encode_controlReqMsg",
                        mock_encode_return_error)
